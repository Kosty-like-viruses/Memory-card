...
questions_list.append(
        Question('Государственный язык Бразилии', 'Португальский', 'Русский', 'Индийский','Английский', 'Испанский', 'Бразильский'))
questions_list.append(
        Question('Какого цвета нет на флаге России?', 'Зелёный', 'Фиолетовый', 'Оранжевый', 'Красный', 'Белый', 'Синий'))
questions_list.append(
        Question('Национальная хижина якутов', 'Ураса', 'Кибаб', 'Хибара',  'Юрта', 'Иглу', 'Хата'))
questions_list.append(
    Question('Столица Франции', 'Париж', 'Лондон', 'Берлин', 'Мадрид', 'Рим', 'Амстердам'))
questions_list.append(
    Question('Самая высокая гора в мире', 'Эверест', 'Килиманджаро', 'Эльбрус', 'Монблан', 'Аконкагуа', 'Мак-Кинли'))
questions_list.append(
    Question('Какой химический элемент обозначается как "O"?', 'Кислород', 'Водород', 'Золото', 'Серебро', 'Углерод', 'Азот'))
...
layout_ans3.addWidget(rbtn_4) # два ответа во второй столбец
